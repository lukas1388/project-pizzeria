...
class Booking{
  constructor(element){
    ...
    thisBooking.selectedTable = []; // właściwość przechowująca informacje o wybranym stoliku
  ...
  render(element){
    ...
    thisBooking.dom.tablesWrapper = element.querySelector(select.booking.tablesWrapper); // wrapper ze stolikami
  }
